...
Draft of presentation to be given at the [IIPC GA 2015](http://www.netpreserve.org/general-assembly/ga2015-schedule).
<!--break-->

---

The UK Web Archive started archiving web content towards the end of 2004 ([e.g. The Hutton Enquiry](http://www.webarchive.org.uk/wayback/archive/*/http://www.the-hutton-inquiry.org.uk/index.html)). This has been a long-term investment, building up the skills and infrastructure needed to support large-scale domain crawls under non-print Legal Deposit. But has the investment been worth it? Given the relevant legal regulations are going to be reviewed, and in principle withdrawn, what should we do? Can we want to look back at the (almost) ten years that have passed since then, can we find a way to see how much we've achieved? Can we find better ways to understand our collections and articulate their value?
...
But all this is rather inward looking. Instead, , we can try to see what content is no longer available on the live web. This is perhaps the most basic way of stating the value of what we've collected, but it addresses the fundamental quality of the web that we need to understand - it's volatility.
